...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPHIVStatusCounseledDefinition;
...
@Component
@Handler(supports= FPHIVStatusCounseledDefinition.class, order=50)
public class FPHIVStatusCounseledEvaluator implements EncounterDataEvaluator {
