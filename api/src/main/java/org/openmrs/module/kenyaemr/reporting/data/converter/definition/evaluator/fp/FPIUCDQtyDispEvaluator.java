...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPIUCDQtyDispDefinition;
...
@Component
@Handler(supports= FPIUCDQtyDispDefinition.class, order=50)
public class FPIUCDQtyDispEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition encounterDataDefinition, EvaluationContext context) throws EvaluationException {
        ...
        String qry="SELECT \n" +
                ...
                "WHERE f.contraceptive_dispensed = 162794\n" +
