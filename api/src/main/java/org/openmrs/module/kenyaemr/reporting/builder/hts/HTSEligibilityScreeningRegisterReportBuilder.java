...
import org.openmrs.module.kenyaemr.reporting.cohort.definition.HTSEligibilityRegisterCohortDefinition;
...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.HTSEligibleForTestDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.HTSGBVstatusDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.HTSLastTestDateDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.HTSLastTestResultsDataDefinition;
...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.HTSPatientTypeDataDefinition;
...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.HTSTBstatusDataDefinition;
...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.HTSTestedBeforeDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.HTSVisitTypeDataDefinition;
...
@Component
@Builds({"kenyaemr.hiv.report.htsEligibilityScreeningRegister"})
public class HTSEligibilityScreeningRegisterReportBuilder extends AbstractReportBuilder {
    ...
    protected DataSetDefinition datasetColumns() {
        ...
        dsd.setName("HTSEligibilitySecreeningInformation");
        ...
        dsd.addColumn("Visit Date", new EncounterDatetimeDataDefinition(),"", new DateConverter(ENC_DATE_FORMAT));
          ...
          // new columns
        dsd.addColumn("Patient Type", new HTSPatientTypeDataDefinition(), null);
        dsd.addColumn("Type of Visit", new HTSVisitTypeDataDefinition(), null);
        dsd.addColumn("Tested for HIV before", new HTSTestedBeforeDataDefinition(), null);
        dsd.addColumn("Date of last HIV testing", new HTSLastTestDateDataDefinition(), null);
        dsd.addColumn("Test result", new HTSLastTestResultsDataDefinition(), null);
        dsd.addColumn("Eligible for testing", new HTSEligibleForTestDataDefinition(), null);
        dsd.addColumn("TB Status ", new HTSTBstatusDataDefinition(), null);
        dsd.addColumn("GBV Status ", new HTSGBVstatusDataDefinition(), null);


        HTSEligibilityRegisterCohortDefinition cd = new HTSEligibilityRegisterCohortDefinition();
