...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPInjectablesTypeOfVisitDefinition;
...
@Component
@Handler(supports= FPInjectablesTypeOfVisitDefinition.class, order=50)
public class FPInjectablesTypeOfVisitEvaluator implements EncounterDataEvaluator {
