...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPVSCDefinition;
...
@Component
@Handler(supports= FPVSCDefinition.class, order=50)
public class FPVSCEvaluator implements EncounterDataEvaluator {
    @Autowired
