...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPMalesCondomsQtyDispDefinition;
...
@Component
@Handler(supports= FPMalesCondomsQtyDispDefinition.class, order=50)
public class FPMalesCondomsQtyDispEvaluator implements EncounterDataEvaluator {
    @Autowired
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition encounterDataDefinition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT \n" +
                ...
                "WHERE f.contraceptive_dispensed IN (164813)\n" +
