...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPInjectablesQtyDispDefinition;
...
@Component
@Handler(supports= FPInjectablesQtyDispDefinition.class, order=50)
public class FPInjectablesQtyDispEvaluator implements EncounterDataEvaluator {
    @Autowired
