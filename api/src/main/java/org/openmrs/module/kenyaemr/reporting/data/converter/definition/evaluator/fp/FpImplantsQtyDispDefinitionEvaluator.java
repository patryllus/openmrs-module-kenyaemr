...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FpImplantsQtyDispDefinition;
...
@Component
@Handler(supports= FpImplantsQtyDispDefinition.class, order=50)
public class FpImplantsQtyDispDefinitionEvaluator implements EncounterDataEvaluator {
    @Autowired
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition encounterDataDefinition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT \n" +
                "    f.encounter_id,\n" +
                "    CAST(f.quantity_dispensed AS UNSIGNED) AS rods_dispensed\n" +
                "FROM kenyaemr_etl.etl_family_planning f\n" +
                "WHERE f.contraceptive_dispensed IN (76022, 162422, 1873) -- 1 Rod, 2 Rods Implanon, Jadelle\n" +
