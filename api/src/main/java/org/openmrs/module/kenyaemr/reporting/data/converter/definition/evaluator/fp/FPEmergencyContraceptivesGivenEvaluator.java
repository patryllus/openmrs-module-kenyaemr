...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPEmergencyContraceptivesGivenDefinition;
...
@Component
@Handler(supports= FPEmergencyContraceptivesGivenDefinition.class, order=50)
public class FPEmergencyContraceptivesGivenEvaluator implements EncounterDataEvaluator {
    @Autowired
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition encounterDataDefinition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT \n" +
                "    f.encounter_id,\n" +
                "    CASE \n" +
                "        WHEN f.contraceptive_dispensed = 160570 THEN 'Y'\n" +
                "        ELSE 'N'\n" +
                "    END AS emergency_contraceptives_given\n" +
