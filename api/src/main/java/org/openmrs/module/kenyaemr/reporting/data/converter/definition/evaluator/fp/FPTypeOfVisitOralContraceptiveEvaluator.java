...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPTypeOfVisitOralContraceptiveDefinition;
...
@Component
@Handler(supports= FPTypeOfVisitOralContraceptiveDefinition.class, order=50)
public class FPTypeOfVisitOralContraceptiveEvaluator implements EncounterDataEvaluator {
    @Autowired
