...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPReferralToDefinition;
...
@Component
@Handler(supports= FPReferralToDefinition.class, order=50)
public class FPReferralToEvaluator implements EncounterDataEvaluator {
    @Autowired
