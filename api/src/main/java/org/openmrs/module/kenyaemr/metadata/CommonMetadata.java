...
public class CommonMetadata extends AbstractMetadataBundle {
	...
	public static final class _PatientIdentifierType {
		...
		public static final String GODS_NUMBER = Metadata.IdentifierType.GODS_NUMBER;
	}
	...
	public void install() {
		...
		install(patientIdentifierType("GODS Number", "Number assigned by MPI", "^[a-zA-Z0-9]+$", "Allows for alphanumeric format",
				null, LocationBehavior.NOT_USED, false, _PatientIdentifierType.GODS_NUMBER));
