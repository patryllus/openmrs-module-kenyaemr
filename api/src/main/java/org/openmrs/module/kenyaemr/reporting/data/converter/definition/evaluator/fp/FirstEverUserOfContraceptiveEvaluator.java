...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FirstEverUserOfContraceptiveDefinition;
...
@Component
@Handler(supports= FirstEverUserOfContraceptiveDefinition.class, order=50)
public class FirstEverUserOfContraceptiveEvaluator implements EncounterDataEvaluator {

    //first_user_of_contraceptive  etl_family_planning
