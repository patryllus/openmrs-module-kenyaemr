...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPProgestinQtyDispDefinition;
...
@Component
@Handler(supports= FPProgestinQtyDispDefinition.class, order=50)
public class FPProgestinQtyDispEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition encounterDataDefinition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT \n" +
                ...
                "WHERE f.contraceptive_dispensed IN (159784)\n" +
