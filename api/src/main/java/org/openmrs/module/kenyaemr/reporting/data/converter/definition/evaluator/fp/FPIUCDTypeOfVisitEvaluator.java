...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPIUCDTypeOfVisitDefinition;
...
@Component
@Handler(supports= FPIUCDTypeOfVisitDefinition.class, order=50)
public class FPIUCDTypeOfVisitEvaluator implements EncounterDataEvaluator {
