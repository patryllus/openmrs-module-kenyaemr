...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPProgestinTypeOfVisitDefinition;
...
@Component
@Handler(supports= FPProgestinTypeOfVisitDefinition.class, order=50)
public class FPProgestinTypeOfVisitEvaluator implements EncounterDataEvaluator {
