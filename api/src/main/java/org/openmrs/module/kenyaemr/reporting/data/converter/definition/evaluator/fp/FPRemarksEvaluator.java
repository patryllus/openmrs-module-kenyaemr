...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPRemarksDefinition;
...
@Component
@Handler(supports= FPRemarksDefinition.class, order=50)
public class FPRemarksEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition encounterDataDefinition, EvaluationContext context) throws EvaluationException {
     ...
     String qry ="SELECT \n" +
                "    f.encounter_id,\n" +
                "    f.reasons_for_referral AS remarks\n" +
