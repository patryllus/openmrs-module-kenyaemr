...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPHIVStatusResultsDefinition;
...
@Component
@Handler(supports= FPHIVStatusResultsDefinition.class, order=50)
public class FPHIVStatusResultsEvaluator implements EncounterDataEvaluator {
    @Autowired
