...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.FPNaturalMethodCounselledDefinition;
...
@Component
@Handler(supports= FPNaturalMethodCounselledDefinition.class, order=50)
public class FPNaturalMethodCounselledEvaluator implements EncounterDataEvaluator {
    //counselled_on_natural_fp etl_family_planning
