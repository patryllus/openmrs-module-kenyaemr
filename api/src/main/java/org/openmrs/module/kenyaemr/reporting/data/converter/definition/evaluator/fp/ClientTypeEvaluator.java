...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.fp.ClientTypeDefinition;
...
@Component
@Handler(supports= ClientTypeDefinition.class, order=50)
public class ClientTypeEvaluator implements EncounterDataEvaluator {
    @Autowired
